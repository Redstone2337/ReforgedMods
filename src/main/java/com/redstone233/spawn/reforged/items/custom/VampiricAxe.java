...
public class VampiricAxe extends AxeItem {

    public VampiricAxe(ToolMaterial material, float attackDamage, float attackSpeed, Settings settings) {
    ...
    public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
        tooltip.add(Text.translatable("item.trsm.vampirism_axe.tooltip1"));
        tooltip.add(Text.translatable("item.trsm.vampirism_axe.tooltip2"));
